...
class Item extends Base
{
    ...
    public function getProperties()
    {
        ...
        if(!is_object($this->_categories[0])) $categories = Category::find()->where(['IN', 'id', $this->_categories])->orderBy(['parent_id' => SORT_ASC])->all();
        $properties = [];
    ...
    {
        $this->_dataProperties = (!empty($this->_categories)) ? new DataProperties($this->properties, $this->data) : $this->_dataProperties;
